...
update msg model =
    case msg of
        ...
        PlaybackTick ->
            let
                handler config =
                    if config.status == PlaybackPaused then
                        ( model, Cmd.none )
        ...
        PlaybackSpeedChange ->
            let
                handler config =
                    let
                        newSpeed =
                            nextPlaybackSpeed config.speed
